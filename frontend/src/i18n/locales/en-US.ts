export default {
  ...
  model: {
    ...
    editor: {
      ...
      isBuiltinLabel: 'Built-in model',
      isBuiltinDesc: 'When enabled, this model becomes a platform-level built-in model visible to every tenant (workspace). Regular tenants can use it but cannot edit or delete it. Enable only when you want it as a shared system-default model for all tenants.',
